--Вывести динамику 10 наиболее популярных категорий за последние
  -- три года: количество подписок, изменение относительно предыдущего
  -- года в абсолютном и относительном выражении, место в рейтинге и
  -- изменение места по сравнению с предыдущим годом.
