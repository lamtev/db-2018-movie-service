...
final class Launcher {
    ...
    public static void main(String[] args) {
        ...
        try (final var connection = DriverManager.getConnection(endpoint.url(), endpoint.user(), endpoint.password())) {
            ...
            final var subscription = new SubscriptionTableGenerator(parameters.usersCount(), parameters.minSubscriptionsPerUser(), parameters.maxSubscriptionsPerUser(), parameters.durationPriceNMoviesMSeasons(), parameters.yearsSinceFirstSubscription());
